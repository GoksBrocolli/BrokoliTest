...
Dhenza = {
    "comment":"╔═════════════════════\nAuto like by:Brokoli🥦\n╚══════════════════════",
    "cctvteks":"𝐇𝐄𝐇𝐄𝐇𝐄𝐇\n𝐊𝐄𝐓𝐀𝐔𝐀𝐍 𝐍𝐆𝐈𝐍𝐓𝐈𝐏 𝐊𝐀𝐍 𝐊𝐀𝐌𝐔",
    "message":"Cieee kepo @!\n╔═════════════════════\nᵀᴴᴬᴺᴷˢ ᶠᴼᴿ ᴬᴰᴰ ᴹᴱ\n╚══════════════════════",
    "welmsg":"\nWelcomeklo mao play Play aja ga peduli aku klo rata\n,",
    "leftmsg":"\nLah Knp Kuar\n",
    "tagteks1":"Brisik Woe",
    "tagteks2":"Brisik pntek",
    "tagteks3":"Yaelah//-.."
	}
...
#=====================[ CIDUK SIDER ]=======================
        if op.type == 55:
            ...
            if op.param1 in pro["prosider"]:
                    ...
                    goks = {'previewUrl': "http://dl.profile.line-cdn.net/"+dz.getContact(op.param2).picturePath, 'i-installUrl': 'http://itunes.apple.com/app/linemusic/id966142320', 'type': 'mt', 'subText': 'creator : Brokoli', 'a-installUrl': 'market://details?id=jp.linecorp.linemusic.android', 'a-packageName': 'jp.linecorp.linemusic.android', 'countryCode': 'JP', 'a-linkUri': 'linemusic://open?target=track&item=mb00000000016197ea&subitem=mt000000000d69e2db&cc=JP&from=lc&v=1', 'i-linkUri': 'linemusic://open?target=track&item=mb00000000016197ea&subitem=mt000000000d69e2db&cc=JP&from=lc&v=1', 'text': dz.getContact(op.param2).displayName, 'id': 'mt000000000d69e2db', 'linkUri': 'https://music.me.me/launch?target=track&item=mb00000000016197ea&subitem=mt000000000d69e2db&cc=JP&from=lc&v=1','MSG_SENDER_ICON': "https://os.line.naver.jp/os/p/"+op.param2,'MSG_SENDER_NAME':  dz.getContact(op.param2).displayName,}
                    if x_name not in ciduk['ceadMember'][op.param1]:
                        ciduk['ceadMember'][op.param1] += x_name                        
                        ciduk['cOM'][op.param1][op.param2] = x_name                        
                        try:
                            dz.sendMessage(op.param1, (x_name), goks, 19)
                        except:
                            print ("error")
            else:
                pass
...
#==================[ REBOOT ]===================
                    ...
                    try:
                        ...
                        restartBot()
                        pass
            elif msg.text in ["mutualan"]:
            	dz.sendMessage(msg.to, "꧁𝐇𝐀𝐘𝐔𝐔 𝐌𝐔𝐓𝐔𝐀𝐋𝐀𝐍 𝐋𝐀𝐇𝐇꧂")
            	dz.sendMessage(msg.to, "Instagram.com/aarrr24")
            
            elif msg.text in ["TesBot"]:
            	dz.sendMessage(msg.to, "Aku Ready Boss")
...
#=================================================
                ...
                dz.sendMessage(msg.to,"MISI NUMPANG NIMBRUNG")
            elif msg.text in ["Salam2"]:
                dz.sendMessage(msg.to,"BOLEH IKUTAN GA?")
#=================================================
...
#=================================================                
                ...
                for i in gid:
                  ...
                  if h == ng:
                    ...
                    dz.sendMessage(i,"ᴀᴜᴛᴏ sɪᴅᴇʀ ʙʏ: Brokoli")
                    pro["prosider"][i] = True
                    with open('pro.json', 'w') as fp:
                        json.dump(pro, fp, sort_keys=True, indent=4)
                    try:
